...
const ItemCtrl = (function () {
  ...
  return {
    ...
    deleteItem: function (itemID) {
      ...
      //remove item by splicing 1 off the index
...
const UICtrl = (function () {
  ...
  return {
    ...
    updateListItem: function (item) {
      ...
      let listAllItems = document.querySelectorAll(UISelectors.listAllItems);
      listItems = Array.from(listAllItems);
...
const App = (function (ItemCtrl, UICtrl) {
  const loadEventListener = function () {
    ...
    //otherwise when pressing enter on edit state it submits a new entry
    ...
    document
      .querySelector(UISelectors.updateItemSubmit)
  ...
  const itemAddSubmit = function (e) {
    ...
    //check input exists
    //use newItem to update the UI
    //first store the item in state using Item Controller
    //then place it in UI with a UI addListItem method
